...
class ProductPage(BasePage):
    ...
    def should_be_success_message(self):
        adding_message = self.browser.find_element(*ProductPageLocators.SUCCESS_MESSAGE)
    ...
    def should_be_message_basket_price_equal_to_product_price(self):
        total_basket_price = self.browser.find_element(
            *ProductPageLocators.TOTAL_BASKET_PRICE_MESSAGE).text.split()[-1]
    ...
    def should_be_product_name_in_adding_message(self):
        ...
        product_name_in_adding_message = self.browser.find_element(
            *ProductPageLocators.PRODUCT_NAME_IN_ADDED_MESSAGE).text
